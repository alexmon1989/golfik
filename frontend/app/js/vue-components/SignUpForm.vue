<template>    
    <div>  
        <form @submit.prevent="validate" id="sign-up-form" class="g-py-15" method="post" action="">
          ...
          <div :class="{'u-has-error-v1': errors.has('email') || (emailErrors.length > 0 && showServerErrors) }" class="mb-4">
          ...
          <div :class="{'u-has-error-v1': errors.has('username') || (usernameErrors.length > 0 && showServerErrors) }" class="mb-4">
            ...
            <small v-if="showServerErrors && usernameErrors.length > 0" class="form-control-feedback">{{ usernameErrors }}</small>
          </div>

          <div class="row">
            <div :class="{'u-has-error-v1': errors.has('password1') || (password1Errors.length > 0 && showServerErrors) }" class="col-xs-12 col-sm-6 mb-4">
              ...
              <small v-if="showServerErrors && password1Errors.length > 0" class="form-control-feedback">{{ password1Errors }}</small>
            </div>

            <div :class="{'u-has-error-v1': errors.has('password2') || (password2Errors.length > 0 && showServerErrors) }" class="col-xs-12 col-sm-6 mb-4">
              ...
              <small v-if="showServerErrors && password2Errors.length > 0" class="form-control-feedback">{{ password2Errors }}</small>
            </div>
          </div>

          <div class="row mb-5">
            <div class="col-12">
              <button class="btn btn-md btn-block u-btn-primary rounded g-py-13 g-px-25" type="submit">Зарегистрироваться</button>
            </div>
          </div>
        </form>
    </div>
