        ...
        <form @submit.prevent="sendMessage" v-if="!sended">
          <div class="row">
            <div :class="{'u-has-error-v1': errors.has('username') }" class="col-md-6 form-group g-mb-20">
              ...
              <input v-validate="'required'" data-vv-as="Имя" v-model="username" name="username" :disabled="processing" class="form-control g-color-gray-dark-v5 g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text">
            ...
            <div :class="{'u-has-error-v1': errors.has('email') }" class="col-md-6 form-group g-mb-20">
              ...
              <input v-validate="'required|email'" data-vv-as="Email" v-model="email" name="email" :disabled="processing" class="form-control g-color-gray-dark-v5  g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="email">
            ...
            <div class="col-md-6 form-group g-mb-20">
              ...
              <input name="subject" v-model="subject" :disabled="processing" class="form-control g-color-gray-dark-v5 g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text">
            </div>

            <div class="col-md-6 form-group g-mb-20">
              <label class="g-color-gray-dark-v2 g-font-size-13">Телефон:</label>
              <input name="phone" v-model="phone" :disabled="processing" class="form-control g-color-gray-dark-v5 g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="tel">
            </div>
            ...
            <div :class="{'u-has-error-v1': errors.has('message') }" class="col-md-12 form-group g-mb-40">
              ...
              <textarea v-validate="'required|min:10'" :disabled="processing" data-vv-as="Сообщение" v-model="message" name="message" class="form-control g-color-gray-dark-v5 g-brd-gray-light-v4 g-brd-primary--focus g-resize-none rounded-3 g-py-13 g-px-15" rows="7"></textarea>
              <small v-show="errors.has('message')" class="form-control-feedback">{{ errors.first('message') }}</small>
            </div>
          </div>

          <button class="btn u-btn-primary rounded-3 g-py-12 g-px-20" type="submit" :disabled="processing" role="button">Отправить сообщение</button>
