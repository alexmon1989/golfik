<template>
  ...
  <form class="g-py-15" @submit.prevent="login">
    ...
    <div :class="{'u-has-error-v1': errors.has('username') }" class="mb-4">
      ...
      <input v-model="username" v-validate="'required'" data-vv-as="Логин" :disabled="processing" name="username"
    ...
    <div class="g-mb-35">
      <div :class="{'u-has-error-v1': errors.has('password') }" class="mb-3">
        ...
        <input v-model="password" v-validate="'required'" data-vv-as="Пароль" :disabled="processing" name="password"
               class="form-control g-color-black g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15"
      ...
      <div class="row justify-content-between">
        <div class="col align-self-center">
          <label class="form-check-inline u-check g-color-gray-dark-v5 g-font-size-12 g-pl-25 mb-0">
            <input v-model="rememberme" :disabled="processing" class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0"
                   type="checkbox">
