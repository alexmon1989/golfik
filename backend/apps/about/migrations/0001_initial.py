# Generated by Django 2.0.2 on 2018-02-15 12:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_1', models.CharField(max_length=255, verbose_name='Заголовок')),
                ('text_2', models.CharField(blank=True, max_length=255, null=True, verbose_name='Текст под заголовком')),
                ('text_3', ckeditor.fields.RichTextField(verbose_name='Текст')),
                ('image', models.ImageField(blank=True, null=True, upload_to='about/', verbose_name='Изображение')),
                ('image_text', models.CharField(blank=True, max_length=255, null=True, verbose_name='Подпись под изображением')),
            ],
            options={
